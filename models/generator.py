...
def get_wgan_generator_model_v5(noise_dim: int):
    ...
    x = Conv2D(96, (3, 3), activation=LeakyReLU(0.2), use_bias=False, padding="same")(x)
    # x = Conv2D(96, (3, 3), activation=LeakyReLU(0.2), padding="same")(x)
    x = upsample_block(
        x,
        64,
        LeakyReLU(0.2),
    ...
    x = Conv2D(48, (3, 3), activation=LeakyReLU(0.2), use_bias=False, padding="same")(x)
    # x = Conv2D(48, (3, 3), activation=LeakyReLU(0.2), padding="same")(x)
    x = upsample_block(
        x,
        32,
        LeakyReLU(0.2),
    ...
    x = Conv2D(24, (3, 3), activation=LeakyReLU(0.2), use_bias=False, padding="same")(x)
    # x = Conv2D(24, (3, 3), activation=LeakyReLU(0.2), padding="same")(x)
    x = upsample_block(
        x,
        16,
        LeakyReLU(0.2),
    ...
    x = Conv2D(8, (3, 3), activation=LeakyReLU(0.2), use_bias=False, padding="same")(x)
...
def get_generator_model_v4(noise_dim: int, class_dim: int):
    ...
    x = Dense(7 * 7 * 256, activation=LeakyReLU(0.2), input_dim=noise_dim)(mul_input)
    x = Reshape((7, 7, 256))(x)
    x = upsample_block(
        x,
        128,
    ...
    x = Conv2D(8, (3, 3), activation=LeakyReLU(0.2), padding="same")(x)
